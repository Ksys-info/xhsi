...
//            this.rose_y_offset = 50 + 4 + this.border_top;
            ...
            this.left_label_vor_y = this.left_label_arpt_y + this.line_height_xs*10/8;
            this.left_label_ndb_y = this.left_label_vor_y + this.line_height_xs*10/8;
            this.left_label_wpt_y = this.left_label_ndb_y + this.line_height_xs*10/8;
            this.left_label_pos_y = this.left_label_wpt_y + this.line_height_xs*10/8;
