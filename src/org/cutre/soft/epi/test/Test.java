...
//  sub sim/aircraft/view/acf_notes
    ...
    static void incl(ExtPlaneInterface iface, Observer<DataRef> s, String name) {
        System.out.println("Including dataRef " + name);
        iface.includeDataRef(name);
        iface.observeDataRef(name, s);
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Setting ExtPlane update interval to 0.1.");
        ExtPlaneCommand epc = new ExtPlaneCommand(ExtPlaneCommand.EXTPLANE_SETTING.UPDATE_INTERVAL, "0.1");
        ...
        incl(iface, s, "sim/cockpit/electrical/strobe_lights_on");
        incl(iface, s, "sim/cockpit2/autopilot/vnav_armed");
        incl(iface, s, "sim/cockpit2/autopilot/vnav_status");
        incl(iface, s, "sim/cockpit2/autopilot/vvi_status");
        incl(iface, s, "sim/cockpit2/autopilot/nav_status");
        incl(iface, s, "sim/cockpit2/autopilot/altitude_hold_status");
        incl(iface, s, "sim/cockpit2/autopilot/altitude_vnav_ft");
        incl(iface, s, "sim/cockpit/autopilot/autopilot_state");
        incl(iface, s, "sim/cockpit2/autopilot/altitude_mode");
        incl(iface, s, "sim/cockpit/autopilot/altitude_mode");
