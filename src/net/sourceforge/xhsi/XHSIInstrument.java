...
public class XHSIInstrument {
    ...
    public static enum DU {
        ...
        CMD0 (CMD_ID+0, "Commander0", 32, 32),
        CMD1 (CMD_ID+1, "Commander1", 32, 32),
        CMD2 (CMD_ID+2, "Commander2", 32, 32),
        CMD3 (CMD_ID+3, "Commander3", 32, 32),
        CMD4 (CMD_ID+4, "Commander4", 32, 32),
        CMD5 (CMD_ID+5, "Commander5", 32, 32),
        CMD6 (CMD_ID+6, "Commander6", 32, 32),
        CMD7 (CMD_ID+7, "Commander7", 32, 32);
    ...
    public static final int CMD_ID = 7;   // Must be last
