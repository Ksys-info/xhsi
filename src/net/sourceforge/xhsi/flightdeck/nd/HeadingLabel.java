...
public class HeadingLabel extends NDSubcomponent {
    ...
    //            null);
            ...
            g2.fillPolygon(x_points_heading_box, y_points_heading_box, 4);
...
//                int hdg_pointer_width = (int) (10.0f * nd_gc.shrink_scaling_factor);
            ...
            // plane symbol
            g2.setColor(nd_gc.aircraft_color);
            int div = preferences.get_small_aircraft_symbol() ? 2 : 1;
            int pw = plane_width / div;
            int ph = plane_height / div;
            if ( nd_gc.mode_classic_hsi ) {
                g2.drawLine(center_x - pw/4, center_y - ph, center_x - pw/4, center_y + ph);
                g2.drawLine(center_x + pw/4, center_y - ph, center_x + pw/4, center_y + ph);
                g2.drawLine(center_x - ph, center_y, center_x - pw/4, center_y);
                g2.drawLine(center_x + pw/4, center_y, center_x + ph, center_y);
                g2.drawLine(center_x - pw/2 - pw/4, center_y + ph, center_x - pw/4, center_y + ph);
                g2.drawLine(center_x + pw/4, center_y + ph, center_x + pw/2 + pw/4, center_y + ph);
            } else {
